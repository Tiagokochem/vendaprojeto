...
NICHE_OPTIONS = [
    ...
    ("salao", "Salão / barbearia", "Agenda e confirmação de horário"),
    ("estetica", "Estética / beleza", "Triagem e avaliação no WhatsApp"),
    ("oficina", "Oficina / auto", "Orçamento e status do serviço"),
